...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> insertSuggestion(Suggestion suggestion) async {
    ...
    // Insert the Suggestion into the correct table. You might also specify the
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                return SuggestionsList(
                    ...
                    updateSuggestion: updateSuggestion,addSuggestion: insertSuggestion);
